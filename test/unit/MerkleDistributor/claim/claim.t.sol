...
contract MerkleDistributorClaimTest is Test, TestMerkleTree {
    ...
    function test_RevertWhen_TheProofIsInvalid() external whenTheLeafHasNotBeenClaimed {
        // It should revert
        vm.assertEq(distributor.isClaimed(claim.index), false);
    ...
    function test_WhenTheProofIsValid() external whenTheLeafHasNotBeenClaimed {
    ...
    function test_RevertWhen_TheLeafHasBeenClaimed() external whenTheLeafHasBeenClaimed {
        // It should revert
